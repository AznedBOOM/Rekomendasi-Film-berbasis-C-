...
int main()
{
    ...
    switch (pilih) {
        case 1:
            ...
            cout << "Get Out mengangkat isu perbudakan dan rasisme yang terjadi khususnya di Amerika Serikat\nyang masih terjadi sampai saat ini.";
            cout << "\n Perasaan Chris sebagai minoritas sangat tergambarkan dalam film.\n";
            cout << "Alur yang tidak membosankan pastinya dapat membuat penonton selalu tertarik dengan jalannya film.\n";
            cout << "Film sangat kami rekomendasikan untuk anda para pecinta film bergenre thriller." << endl;
            break;
        case 2:
            ...
            cout << "Dipilihlah wanita bernama Lisbeth Salander, seorang penyelidik dan hacker handal.\nBersama, mereka mencoba memecahkan misteri hilangnya putri\nHenrik yang telah hilang selama 40 tahun.\n";
            cout << "\nReview dari kami:\n"<< endl;
            ...
            cout << "Plot twist yang tidak terduga dan akting pemain yang bagus membuat \nfilm ini masuk ke dalam daftar film dengan genre thriller-crime-mystery terbaik." << endl;
            break;
        case 3:
            ...
            cout << "Kasus tersebut semakin gempar semenjak hilangnya anak seorang kepala polisi saat mengunjungi gua\ntersebut bersama sang tokoh utama bernama Jonas dan teman-temannya. " << endl;
            cout << "\nReview dari kami:\n " << endl;
            ...
            cout << "Dark membawa-kan tema perjalanan waktu yang penuh dengan paradoks dan hubungan sebab-akibat\nyang membuat serial ini harus ditonton dengan cermat agar memahami sepenuhnya\napa maksud dari salah satu serial terbaik Netflix ini.\n";
        ...
        case 4:
            cout << "4. Snowpiercer\n" << endl;
            cout << "Sinopsis:\n" << endl;
            cout << "Snowpiercer adalah film yang disutradarai oleh Bong Joon-Ho tentang sebuah kereta\nyang berjalan tanpa henti pada saat bumi sudah mengalami kehancuran akibat jaman es.\n";
            cout << "Karakter utama bernama Curtis ingin mencoba memberontak akibat perlakuan tidak adil\nkalangan atas kepada gerbong belakang yang hidup kumuh.\n";
            cout << "Dibantu oleh orang-orang di gerbong belakang dan seorang pria korea dan anak perempuannya,\nmereka mencoba menerobos pertahanan dan mengambil alih kereta." << endl;
            ...
            cout << "Walaupun banyak terdapat plot hole dan ending yang kurang memuaskan,\nbukan berarti film ini tidak layak tonton.\n";
        ...
        case 5:
            ...
            cout << "Bercerita tentang Geralt of Rivia, seorang Witcher(sebutan orang yang telah termutasi akibat percobaan),\nseorang putri kerajaan bernama Ciri, dan Yennefer,penyihir cacat. ";
            ...
            cout << "Film penuh politik dan benang-benang alur yang awalnya ruwet dapat tersambung dengan bagus di akhir episode.\n";
            cout << "Bagi orang yang menikmati film seperti ini pastinya tidak keberatan memberi film ini kesempatan.\n";
